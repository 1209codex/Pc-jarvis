...
from jarvis.tools.system_tools import OpenApplicationTool, SetVolumeTool, BatteryStatusTool, NaturalLanguageCalculatorTool, SpeakTool, SmartSoftwareInstallerTool
...
class AssistantRuntime:
    ...
    def _register_default_tools(self):
        tools = [
            ...
            OpenApplicationTool(), SetVolumeTool(), BatteryStatusTool(), NaturalLanguageCalculatorTool(), SpeakTool(), SmartSoftwareInstallerTool(),
